...
def main(ext_input = None, ext_time_limit = 60, what_to_explain = 'columns', target_type = 'TEXTUAL',
    ...
    for test_file in test_files:
        ...
        if what_to_explain == 'columns':
            ...
            # print('here')
            search_space = add_ops()
        final_node, open_nodes, closed_nodes = a_star_search(raw_data, target, search_space, debug_level,
